...
public class CognitoSecurityAutoConfiguration {
    ...
    @EnableWebSecurity
    @ConditionalOnProperty(prefix = "jmix.awssec.apiSecurity", name = "enabled", havingValue = "true",
            matchIfMissing = true)
    ...
    private static class OnUiSecurityPropertiesCondition extends AllNestedConditions {
        ...
        @ConditionalOnProperty(prefix = "jmix.awssec.uiSecurity", name = "enabled", havingValue = "true")
        static class UiSecurityEnabledProperty {
        }

        @ConditionalOnProperty(prefix = "jmix.awssec", name = "clientId")
        static class HasClientIdProperty {
        }

        @ConditionalOnProperty(prefix = "jmix.awssec", name = "domain")
